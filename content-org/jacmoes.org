...
<br/>
#+end_export
I switched to Doom-Emacs after declaring Emacs Bankruptcy [fn:emacsbankruptcy: When your InitFile gets so large that you really need to start over, then you have declared “.emacs bankruptcy”.], and I haven’t regretted it. It uses every trick in the book to optimize, and the install/upgrade/maintenance scripts are excellent.
** Org-mode
